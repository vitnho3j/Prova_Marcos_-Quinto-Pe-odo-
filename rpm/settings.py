"""
Django settings for rpm project.
...
SECRET_KEY = 'jx7y1i3%&%un&8=4rf$!2bec$bw%4cnot+!k4r=9q@wp8h@3&a'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['rpm-vdss.herokuapp.com', '127.0.0.1', 'localhost']
...
ROOT_URLCONF = 'rpm.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['aplic/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
if DEBUG:
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.gb.backends.postgresql',
            'NAME': 'rpm'
            'USER': 'vitor'
            'PASSWORD': 'aklmnhmla'
            'HOST': 'localhost'
